...
export default Vue.extend({
    ...
    methods: {  
        ...
        loadNewSuggestionsAC(): void {
            ...
            const allResults = (document.getElementById(this.resutlsSpanID) as HTMLSpanElement)?.textContent??"{}";
            ...
            const allDocumentations = (document.getElementById(this.documentationSpanID) as HTMLSpanElement)?.textContent??"{}";
            ...
            const allTypes = (document.getElementById(this.typesSpanID) as HTMLSpanElement)?.textContent??"{}";
