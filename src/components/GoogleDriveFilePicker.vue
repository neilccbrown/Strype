    ...
    methods: {
        ...
        createPicker() {
            ...
            if(!this.isSaveAction) {
                ...
                (allStrypeDocsView as any).setLabel((this.$t("appMessage.gdriveAllStrypeFiles")));
            ...
            if(!this.isSaveAction) {
                ...
                (pythonFilesDocsView as any).setLabel(this.$t("appMessage.gdriveAllPythonFiles"));
            ...
            const pickerBuilder = new google.picker.PickerBuilder()
                ...
                .setTitle(this.$t((this.isSaveAction) ? "appMessage.selectFolder" : "appMessage.selectStrypeFile"));        
