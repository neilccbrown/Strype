    ...
    methods: {       
        updateAvailableDemos() {
            ...
            this.availableDemos = [
                ...
                {name: this.$t("demos.builtinGraphics"), demos: getBuiltinDemos("demos/graphics/")},
                {name: this.$t("demos.builtinTurtle"), demos: getBuiltinDemos("demos/turtle/")},
                {name: this.$t("demos.builtinConsole"), demos: getBuiltinDemos("demos/console/")},
                // #v-else
                ...
                {name: this.$t("demos.builtinMicrobit"), demos: getBuiltinDemos("demos/microbit/")},
                // #v-endif
